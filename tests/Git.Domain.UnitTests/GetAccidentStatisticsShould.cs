    ...
    public partial class TransportForLondonClientShould
    {
        public class GetAccidentStatisticsShould : TransportForLondonClientShould
        {
            ...
            public async void ShouldGetFirstPageAccidentStatistics_WhenThereIsNoSecondPage()
            {
                ...
                var actual =
                    await this.TransportForLondonClient.GetAccidentStatistics(year: 2016, page: 2, pageSize: 5);
            ...
            public async void ShouldGetFirstPageAccidentStatistics_WhenThePageIsLessThanOne()
            {
                ...
                var actual =
                    await this.TransportForLondonClient.GetAccidentStatistics(year: 2016, page: -1, pageSize: 5);
            ...
            [Fact]
            public async void ShouldFilterWithFatalSeverityOverSeveralYearsAscending()
            {
            ...
            [Fact]
            public async void SwapValuesIfFromGreaterThanTo()
            {
                var accidentStatistics = Get2007AccidentData();
                this.HttpTest.ResponseQueue.Enqueue(CreateHttpResponseMessage(accidentStatistics));
                this.HttpTest.ResponseQueue.Enqueue(CreateHttpResponseMessage(accidentStatistics));
            ...
            public void ThrowNotSupportedExceptionWhenFromRangeLessThan2005()
            {
                ...
                action.Should()
                    ...
                    .WithMessage(ErrorMessages.DatesBelow2005NotSupported);
            }
            ...
            public void ThrowNotSupportedExceptionWhenFromOrTooRangeInCurrentYear()
            {
                ...
                action.Should()
                    .Throw<NotSupportedException>()
                    .WithMessage(ErrorMessages.DatesFromCurrentYearNotSupported);
            }
        }
    }
}